  ...
  return (
    <>
      ...
      <div className="product-details-container">
        {/* Display the sidebar */}
        <SideBar />
        {/* Display the search bar and apply search filter */}
        <SearchBar products={products} onSearch={handleSearch} />{" "}
        {/* Pass the products prop */}
        {/* List of products */}
        <CartOverview />
        <div className="product-list">
          {/* Iterate over filtered products and display each card */}
          {filteredProducts.map((product) => (
            <div key={product.id} product={product} className="card card-item">
              <div className="img-box">
                {/* Display product image */}
                <div className="card-img-top" style={{ width: "10rem" }}>
                  <img

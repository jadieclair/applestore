...
import "./styles/ChangePaymentInfo.css";
...
const ChangePaymentInfo = () => {
  ...
  const [expirationDate, setExpirationDate] = useState(
    user.paymentMethod.expirationDate
  );
  ...
  return (
    <div className="payment-info-container">
      <div className="payment-methods">
        <h2 className="card-head">SELECT A CARD</h2>
        <br />
        <div className="card-option">
          ...
          <span className="mastercard-end">MasterCard ending in 4242</span>
        </div>
        <br />
        <div>
          <svg
          ...
          <span className="mastercard-end">VISA Debit ending in 2894</span>
        </div>
      </div>
      <div className="container-form">
        <div className="centered-border-payment">
          <div className="pay-head">
            <h2 className="pay-head"> ADD A NEW CARD</h2>
          </div>
          <form className="payment-form" onSubmit={handleSubmit}>
            <label htmlFor="type" className="holdername">
              Cardholder Name
            </label>
            ...
            <br />
            <label htmlFor="cardNumber" className="cardname">
              Card Number
            </label>
            <div className="input-form">
              <svg
            ...
            <br />
            <div className="expier-container">
              <div className="input-form-small-1">
                <label htmlFor="expirationDate" className="expire-title">
                  Expiry Date
                </label>
              ...
              <div className="input-form-small-2">
                <label htmlFor="cvv" className="cvc">
                  CVC
                </label>
                <div className="input-exp">
                  <input
            ...
            <div className="add-button">
              <button className="pay-btn pay-text" type="submit">
                <svg
                  width="25"
                  height="24"
                  viewBox="0 0 25 24"

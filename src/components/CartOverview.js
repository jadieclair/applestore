...
import { useBag } from "./BagContext"; // Importing the useBag hook from BagContext
import "./styles/CartOverview.css"; // Importing the CSS styles for the component

// Component for displaying a summary of items in the bag
const CartOverview = ({ selectedImage }) => {
  // Using the useBag hook to access bagItems from BagContext
    ...
    <div className="line">
      <div className="bagbar">
        ...
        <div className="bag-images">
          {/* Mapping through bagItems and displaying item images */}
        ...
        {/* Link to navigate to the Bag page */}
        <Link to="/Bag" className="bag-link">
          <button className="bag-button">
            <svg
              className="sidebag-icon"
              width="24"
              height="24"
              viewBox="0 0 24 24"
              fill="none"
